...
PROVIDERS = (
    ...
    {"id": "tongcheng", "name": "同程", "group": "国内旅行平台", "description": "国内初始航班列表含税参考价；国际暂不支持"},
    {"id": "qunar", "name": "去哪儿", "group": "国内旅行平台", "description": "国内/国际公开低价日历；国内未含税价单独展示"},
    {"id": "fliggy", "name": "飞猪", "group": "国内旅行平台", "description": "国内普通成人经济舱票价加实际税费；排除年龄/会员优惠"},
